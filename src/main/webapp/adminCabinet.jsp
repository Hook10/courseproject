...
<h3>
   ...
   ${sessionScope.admin.login}
    ...
    <a href="${pageContext.request.contextPath}/home/create_admin_button" type="button" class="btn btn-secondary"> <fmt:message key="create.admin"/></a>
    <a href="${pageContext.request.contextPath}/home/create_supplier_button" type="button" class="btn btn-secondary"><fmt:message key="create.supplier"/></a>
    <a href="${pageContext.request.contextPath}/home/show_all_customers" type="button" class="btn btn-info">Show all customers</a>
    </c:when>
    <c:otherwise>
