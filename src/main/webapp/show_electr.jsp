...
<div class="container-lg">
    ...
    <a href="${pageContext.request.contextPath}/home/show_electricity?theLocale=en_US"type="button" class="btn btn-info">English (US)</a>  |
    <a href="${pageContext.request.contextPath}/home/show_electricity?theLocale=ru_RU"type="button" class="btn btn-info">Русский (RU)</a>
    <br/><br/>
